  ...
  module Connection
    ...
    def default_middleware(options={})
      Proc.new do |builder|
        ...
        builder.use FaradayMiddleware::OAuth, {:consumer_key => client_id, :consumer_secret => client_secret, :token => oauth_token, :token_secret => oauth_secret, :ignore_extra_keys => true} if client_id? and client_secret?
